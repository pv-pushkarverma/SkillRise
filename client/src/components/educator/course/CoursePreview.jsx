const CoursePreview = ({
  ...
  <div className="hidden lg:flex flex-col gap-4 w-72 xl:w-80 shrink-0 sticky top-24">
    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl overflow-hidden shadow-sm">
      ...
      <div className="w-full aspect-video bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800 flex items-center justify-center">
        {image ? (
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          {price > 0 ? (
            ...
            <span className="text-sm text-gray-300 dark:text-gray-600 italic">Price not set</span>
          )}
        </div>
