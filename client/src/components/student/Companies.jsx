...
const Companies = ({ compact = false }) => {
  return (
    <div className={compact ? '' : 'pt-16'}>
      <p className='text-sm md:text-base text-gray-500'>Trusted by learners from</p>

      <div className={`flex flex-wrap items-center justify-center gap-6 md:gap-16 ${compact ? 'mt-6' : 'md:mt-10 mt-5'}`}>
