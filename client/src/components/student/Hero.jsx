    ...
    <section className="relative w-full overflow-hidden">
      ...
      <div className="relative px-4 sm:px-6 lg:px-8 pt-16 md:pt-24 pb-10">
        <div className="max-w-4xl mx-auto text-center">
          <p className="inline-flex items-center gap-2 text-xs font-semibold tracking-wide uppercase px-3 py-1 rounded-full bg-white/70 dark:bg-gray-800/70 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200">
            Learn. Build. Level up.
          </p>

          <h1 className="mt-5 text-3xl sm:text-4xl md:text-6xl font-bold text-gray-900 dark:text-white leading-tight">
          ...
          <div className="mt-7 flex flex-col items-center gap-4">
            ...
            <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 text-sm text-gray-600 dark:text-gray-300">
              <span className="font-medium text-gray-800 dark:text-gray-100">Popular:</span>
