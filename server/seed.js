      ...
      },
      {
        ...
        chapterContent: [
          ...
          },
          {
            ...
            lectureDuration: 19,
            lectureUrl: 'https://www.youtube.com/watch?v=R8_veQiYBj',
            isPreviewFree: false,
            lectureOrder: 2,
          },
        ],
...
const seed = async () => {
  ...
  const purchases = [
    ...
    {
      courseId: courseUX._id,
      userId: 'user_seed_student1',
      amount: 2549,
      currency: 'INR',
      providerOrderId: 'order_seed_002',
      providerPaymentId: 'pay_seed_002',
      status: 'completed',
    },
    {
      ...
      amount: 1999,
      currency: 'INR',
      providerOrderId: 'order_seed_003',
      providerPaymentId: 'pay_seed_003',
      status: 'completed',
    },
    {
      courseId: courseRN._id,
      userId: 'user_seed_student1',
      amount: 2969,
      currency: 'INR',
      providerOrderId: 'order_seed_004',
      providerPaymentId: 'pay_seed_004',
      status: 'completed',
    },
    {
      courseId: courseSD._id,
      userId: 'user_seed_student1',
      amount: 4499,
      currency: 'INR',
      providerOrderId: 'order_seed_005',
      providerPaymentId: 'pay_seed_005',
      status: 'completed',
    },
    {
      courseId: courseNext._id,
      userId: 'user_seed_student1',
      amount: 3039,
      currency: 'INR',
      providerOrderId: 'order_seed_006',
      providerPaymentId: 'pay_seed_006',
      status: 'completed',
    },
    {
      courseId: courseWeb._id,
      ...
      amount: 2799,
      currency: 'INR',
      providerOrderId: 'order_seed_007',
      providerPaymentId: 'pay_seed_007',
      status: 'completed',
    },
    {
      courseId: courseDS._id,
      userId: 'user_seed_student2',
      amount: 3599,
      currency: 'INR',
      providerOrderId: 'order_seed_008',
      providerPaymentId: 'pay_seed_008',
      status: 'completed',
    },
    {
      courseId: courseTS._id,
      ...
      amount: 1999,
      currency: 'INR',
      providerOrderId: 'order_seed_009',
      providerPaymentId: 'pay_seed_009',
      status: 'completed',
    },
    {
      courseId: courseDO._id,
      userId: 'user_seed_student2',
      amount: 2624,
      currency: 'INR',
      providerOrderId: 'order_seed_010',
      providerPaymentId: 'pay_seed_010',
      status: 'completed',
    },
    {
      courseId: courseDjango._id,
      userId: 'user_seed_student2',
      amount: 2379,
      currency: 'INR',
      providerOrderId: 'order_seed_011',
      providerPaymentId: 'pay_seed_011',
      status: 'completed',
    },
    {
      courseId: courseNext._id,
      ...
      amount: 3039,
      currency: 'INR',
      providerOrderId: 'order_seed_012',
      providerPaymentId: 'pay_seed_012',
      status: 'completed',
    },
    {
      courseId: courseDS._id,
      ...
      amount: 3599,
      currency: 'INR',
      providerOrderId: 'order_seed_013',
      providerPaymentId: 'pay_seed_013',
      status: 'completed',
    },
    {
      courseId: courseUX._id,
      ...
      amount: 2549,
      currency: 'INR',
      providerOrderId: 'order_seed_014',
      providerPaymentId: 'pay_seed_014',
      status: 'completed',
    },
    {
      courseId: courseDO._id,
      ...
      amount: 2624,
      currency: 'INR',
      providerOrderId: 'order_seed_015',
      providerPaymentId: 'pay_seed_015',
      status: 'completed',
    },
    {
      courseId: courseRN._id,
      ...
      amount: 2969,
      currency: 'INR',
      providerOrderId: 'order_seed_016',
      providerPaymentId: 'pay_seed_016',
      status: 'completed',
    },
    {
      courseId: courseCyber._id,
      userId: 'user_seed_student3',
      amount: 2559,
      currency: 'INR',
      providerOrderId: 'order_seed_017',
      providerPaymentId: 'pay_seed_017',
      status: 'completed',
    },
    {
      courseId: courseSD._id,
      ...
      amount: 4499,
      currency: 'INR',
      providerOrderId: 'order_seed_018',
      providerPaymentId: 'pay_seed_018',
      status: 'completed',
    },
    {
      courseId: courseNext._id,
      ...
      amount: 3039,
      currency: 'INR',
      providerOrderId: 'order_seed_019',
      providerPaymentId: 'pay_seed_019',
      status: 'completed',
    },
  ]
